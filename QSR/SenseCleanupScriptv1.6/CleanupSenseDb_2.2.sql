/* ##############################################################################################################################
   Script Name: CleanupSenseDb_2.2
...
DELETE FROM "StaticContentReferences" WHERE "ID" NOT IN (SELECT "StaticContentReference_ID" FROM "StaticContentReferenceAppContents" WHERE "StaticContentReference_ID" IS NOT NULL) AND "ExternalPath" LIKE '%appcontent/%';
DELETE FROM "StaticContentReferenceAppContents" WHERE "AppContent_ID" NOT IN (SELECT "ID" FROM "AppContents" WHERE "ID" IS NOT NULL);
...
DELETE FROM "FileReferences" WHERE "ID" NOT IN (SELECT "FileReference_ID" FROM "FileReferenceStaticContentReferences" WHERE "FileReference_ID" IS NOT NULL) AND "FileType"=2;
...
DELETE FROM "FileReferences" WHERE "ID" NOT IN (SELECT "File_ID" FROM "AppInternals" WHERE "File_ID" IS NOT NULL) AND "FileType"=6;
